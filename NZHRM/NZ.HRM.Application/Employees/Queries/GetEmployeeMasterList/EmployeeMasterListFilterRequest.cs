...
/// <summary>
/// Filter request object for employee master list query.
/// All filter parameters are optional - omit to include all records.
/// </summary>
public class EmployeeMasterListFilterRequest
{
    /// <summary>
