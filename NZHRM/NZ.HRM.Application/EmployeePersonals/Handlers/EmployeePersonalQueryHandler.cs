...
public class EmployeePersonalQueryHandler
{
    ...
    {
        List<NZ.HRM.Domain.Entities.HrmEmployeePersonal> employeePersonals;
        ...
        if (!string.IsNullOrEmpty(query.EmployeeId))
        {
            ...
            employeePersonals = single != null ? new List<NZ.HRM.Domain.Entities.HrmEmployeePersonal> { single } : new List<NZ.HRM.Domain.Entities.HrmEmployeePersonal>();
        }
        else
        {
